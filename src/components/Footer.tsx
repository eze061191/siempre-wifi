      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-column">
            ...
            <p>Internet sin límites para tu estilo de vida digital.</p>
          ...
          <div className="footer-column">
            <h4>Productos</h4>
            <ul>
              <li><a href="#planes" onClick={(e) => scrollToSection(e, 'planes')}>Planes móviles</a></li>
              <li><a href="#planes" onClick={(e) => scrollToSection(e, 'planes')}>Internet hogar</a></li>
              <li><a href="#planes" onClick={(e) => scrollToSection(e, 'planes')}>Planes empresariales</a></li>
              <li><a href="/" onClick={(e) => e.preventDefault()}>Dispositivos</a></li>
            </ul>
          </div>
          <div className="footer-column">
            <h4>Soporte</h4>
            <ul>
              ...
              <li><a href="/" onClick={(e) => e.preventDefault()}>Estado del servicio</a></li>
              <li><a href="/" onClick={(e) => e.preventDefault()}>Portabilidad</a></li>
            </ul>
          </div>
          <div className="footer-column">
            <h4>Empresa</h4>
            <ul>
              <li><a href="#nosotros" onClick={(e) => scrollToSection(e, 'nosotros')}>Sobre nosotros</a></li>
              <li><a href="/" onClick={(e) => e.preventDefault()}>Blog</a></li>
              <li><a href="/" onClick={(e) => e.preventDefault()}>Trabaja con nosotros</a></li>
        ...
        <div className="footer-bottom">
          <p>&copy; 2025 Siempre WiFi. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
