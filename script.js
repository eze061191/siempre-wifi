...
// ===== CONSOLE MESSAGE =====
console.log('%c¡Bienvenido a Siempre WiFi! 📶', 'color: #F78700; font-size: 20px; font-weight: bold;');
console.log('%c¿Interesado en trabajar con nosotros? Envía tu CV a: contacto@siemprewifi.com', 'color: #666; font-size: 12px;');
